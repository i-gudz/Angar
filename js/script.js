$(function() {
    ...
    function updateSlideshowForSelectedPage() {
        ...
        if (!settings.continuous) {
            reachedLastPage ? $("#slider #next").addClass("hidden") : $("#slider #next").removeClass(
                "hidden");
            reachedFirstPage ? $("#slider #prev").addClass("hidden") : $("#slider #prev").removeClass(
                "hidden");
        }
...
var next = document.getElementById('open_next_pop');
